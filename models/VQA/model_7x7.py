...
from modeling import BertConfig, BertModel_module, BertLayerNorm, BertEmbeddings_pos, SnailModel_module, BertLayer
from modeling import BertCore, BertMT
import copy
...
class simple_vqa_model(nn.Module):
    ...
    def register_grad_im7x7(self, grad):
        self.grad_7x7 = [grad]

    def register_grad_36(self, grad):
        self.grad_36 = [grad]

    def register_grad_words(self, grad):
        self.grad_words = [grad]

    def forward(self,ifv,ifv_7x7,qtokens):
        #ifv: [batch, nbox, nhimage]
        #ibox: [batch, 7,7,nhimage]
        #qtokens: [batch,length]
        #ifv.register_hook(self.register_grad_36)
        #ifv_7x7.register_hook(self.register_grad_im7x7)
